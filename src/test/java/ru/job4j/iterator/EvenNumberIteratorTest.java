...
class EvenNumberIteratorTest {
    private Iterator<Integer> iterator;

    @BeforeEach
    public void setUp() {
        iterator = new EvenNumberIterator(new int[] {1, -3, 2, 3, 5, 5, -4, 5, 6, 7});
    }
    ...
    void  shouldReturnFalseIfNoAnyEvenNumbers() {
        iterator = new EvenNumberIterator(new int[]{1});
        assertThat(iterator.hasNext()).isFalse();
    }

    @Test
    void  shouldReturnFalseIfNoAnyNumbers() {
        iterator = new EvenNumberIterator(new int[]{});
        assertThat(iterator.hasNext()).isFalse();
    }

    @Test
    void allNumbersAreEven() {
        iterator = new EvenNumberIterator(new int[] {2, 4, 6, 8});
        assertThat(iterator.hasNext()).isTrue();
        assertThat(iterator.next()).isEqualTo(2);
        assertThat(iterator.hasNext()).isTrue();
        assertThat(iterator.next()).isEqualTo(4);
    ...
    void allNumbersAreOdd() {
        iterator = new EvenNumberIterator(new int[] {1, 3, 5, 7});
        assertThat(iterator.hasNext()).isFalse();
        assertThat(iterator.hasNext()).isFalse();
    }
}